export default function ThemePicker({ selectedTheme, handleThemeClick }) {
  return (
    <div className="grid grid-cols-2 gap-4">
      <div 
        className={`rounded-lg shadow-md p-4 cursor-pointer ${selectedTheme === "Landscape" ? "ring-2 ring-blue-400" : ""}`}
      ...
      >
        ...
        <h3 className="text-xl font-semibold">Landscape</h3>
      </div>
      <div 
        className={`rounded-lg shadow-md p-4 cursor-pointer ${selectedTheme === "Space" ? "ring-2 ring-purple-400" : ""}`}
      ...
      <div 
        className={`rounded-lg shadow-md p-4 cursor-pointer ${selectedTheme === "Nature" ? "ring-2 ring-green-400" : ""}`}
      ...
      <div 
        className={`rounded-lg shadow-md p-4 cursor-pointer ${selectedTheme === "Humanity" ? "ring-2 ring-orange-400" : ""}`}
      ...
      >
        ...
        <h3 className="text-xl font-semibold">Humanity</h3>
      </div>
    </div>
  );
}
